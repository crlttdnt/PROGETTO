...
<section class="container-xl mx-auto my-5">
    <div class="bg-white mx-auto p-5 rounded-4 fit-content border border-secondary border-10">
        <h5 class='fw-medium'>Visualizza Volontari che non hanno mai svolto Attività "123":</h5>
...
{
    $options = [
        'attvita' => 'Attività 123'
    ];

    $string = "<select class='form-select' name='attivita'>";
