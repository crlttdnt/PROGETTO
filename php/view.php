        ...
        <div class="bg-white mx-auto p-5 rounded-4 fit-content border border-secondary border-10" style="width: 100%;">
            ...
            <div class='d-flex justify-content-between align-items-center text-center mt-10' style='padding:35px'>
                <div class='align-items-center'>
                    ...
                    <a href='../examples/volontariattivita.php'>
                    <button class='btn btn-outline-dark' type='submit'>
                            Vai alla pagina 
                        <svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-arrow-up-right' viewBox='0 0 16 16'>
                            <path fill-rule='evenodd' d='M14 2.5a.5.5 0 0 0-.5-.5h-6a.5.5 0 0 0 0 1h4.793L2.146 13.146a.5.5 0 0 0 .708.708L13 3.707V8.5a.5.5 0 0 0 1 0z'/>
                ...
                <div class='align-items-center'>
                    <h3 class='fw-bold fs-6 text-uppercase'> Volontari senza Attività con Scelta
                    </h3>
                    <a href='../examples/volontariattivita-conscelta.php'>
                    <button class='btn btn-outline-dark' type='submit'>
                            Vai alla pagina 
                        <svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-arrow-up-right' viewBox='0 0 16 16'>
                            <path fill-rule='evenodd' d='M14 2.5a.5.5 0 0 0-.5-.5h-6a.5.5 0 0 0 0 1h4.793L2.146 13.146a.5.5 0 0 0 .708.708L13 3.707V8.5a.5.5 0 0 0 1 0z'/>
